    ...
    try {
      for (const play of plays) {
        ...
        const res = await pool.query(
          `INSERT INTO movies (title, description, show_date, show_time, price, image, featured)
          VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING id`,
          [play.title, play.description, play.show_date, play.show_time, play.price, imageBuffer, play.featured]
        );
