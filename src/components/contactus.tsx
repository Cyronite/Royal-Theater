...
export default function ContactSection() {
  return (
    <section className="max-w-6xl mx-auto p-6 text-white bg-[black]">
      <h2 className="text-3xl font-bold text-center mb-2">Contact Us</h2>
      <p className="text-center font-inter text-gray-300 mb-10 max-w-xl mx-auto">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div>
              ...
              <input
                ...
                className="w-full rounded-md bg-[#120d0a] border border-transparent focus:border-[#E7B008] p-2 text-white"
              />
            </div>
            <div>
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              className="w-full rounded-md bg-[#120d0a] border border-transparent focus:border-[#E7B008] p-2 text-white resize-none"
            ></textarea>
          </div>
...
function ContactInfoCard({ icon, title, lines }) {
  return (
    <div className="bg-[#1a140f] rounded-md p-4 flex gap-4 items-start">
      <div className="bg-[#E7B008] p-3 rounded-md text-black text-xl">{icon}</div>
      <div>
